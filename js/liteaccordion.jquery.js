            ...
            core = {
                ...
                triggerSlide : function(e) {
                    ...
                    if ($this.hasClass('selected') && $this.position().left < slideWidth / 2) {
                        ...
                        if(tab.index==0){
                           console.log("first is enabled");
                           //$("#test1").animate({left: "-300px"});
                            $(".colors").animate({left: "-640px"},700);
                            $(".second").animate({left: "67px"},700);
                           }
                           else{
                             console.log("first is not enabled");
                             //$("#test1").animate({left: "-700px"},700);
                             //$(".second").animate({left: "67px"},700);
                             $(".wheels").animate({left: "-310px"},500);
                            } 
                     
                        //$("#test2").animate({left: "-300px"});
                       
                        
                    }else {
                        // animate groups
                        console.log("first is again enabled");
                       // $("#test1").animate({left: "0px"},700);
                       // $(".second").animate({left: "835px"},700);
